...
class PGUI_Helper:
    ...
    def __init__(self, manager, manag2):
        ...
        self.loc__frame_up    = UIImage       (image_surface=imgLoad(bg_handler('frame_up')),    relative_rect=pygame.Rect((toPxX(14), toPxY(4)),  (toPxX(72), toPxY(2))),  manager=manager)
        self.loc__frame_down  = UIImage       (image_surface=imgLoad(bg_handler('frame_down')),  relative_rect=pygame.Rect((toPxX(14), toPxY(47)), (toPxX(72), toPxY(2))),  manager=manager)
        self.loc__frame_left  = UIImage       (image_surface=imgLoad(bg_handler('frame_left')),  relative_rect=pygame.Rect((toPxX(14), toPxY(4)),  (toPxY(2),  toPxY(45))), manager=manager)
        self.loc__frame_right = UIImage       (image_surface=imgLoad(bg_handler('frame_right')), relative_rect=pygame.Rect((toPxX(85), toPxY(4)),  (toPxY(2),  toPxY(45))), manager=manager)
        self.loc__frame_cr_lu = UIImage       (image_surface=imgLoad(bg_handler('frame_cr_lu')), relative_rect=pygame.Rect((toPxX(14), toPxY(4)),  (toPxY(2),  toPxY(2))),  manager=manager)
        self.loc__frame_cr_ld = UIImage       (image_surface=imgLoad(bg_handler('frame_cr_ld')), relative_rect=pygame.Rect((toPxX(14), toPxY(47)), (toPxY(2),  toPxY(2))),  manager=manager)
