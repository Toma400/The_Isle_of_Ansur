...
class TTooltip:
    ...
    def draw(self, screen, rel_pos: (int, int), txt_colour, bg_colour):
        """
    ...
    def _resize(path: str, dest: (int, int)) -> str:
        ...
        buf_img.save(f"_temp/img/{path}")
        return f"_temp/img/{path}"