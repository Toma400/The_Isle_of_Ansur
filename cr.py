...
while True:
    ...
    #-----------------
    # objects managing screens, instead of list with [0-predefined number?]
    # so it will be slots with indefinite amount, by *args?
    # switch_scr(dest, Obj(slot)) <- like that, smh
